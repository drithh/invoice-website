...
/* Creating a new class called `EmailVerificationTest` that extends the `TestCase` class. */
...
class EmailVerificationTest extends TestCase
{
    ...
    /**
     * It asserts that the email verification screen can be rendered
     */
    ...
    /**
     * It verifies the email address of the user.
     */
